<h4 class="modal-title" id="itmesModalLabel">Edit Customer Info</h4>
...
<div class="modal-form">
    <form enctype="multipart/form-data" id="customer_edit_form" autocomplete="off">
        ...
        <div class="row">
            <div class="col-md-6 pr-2">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="customer_gst_number" name="customer_gst_number" value="{{ $customer_object->customer_gst_number }}">
                </div>
            </div>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control form-textarea" id="customer_address" name="customer_address" rows="6">{{ $customer_object->customer_address }}</textarea>
        </div>
